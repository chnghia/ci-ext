	...
	Ext.onReady(function() {
		...
		var tree = new Ext.tree.TreePanel({
			root:{text:'root', id:'root', expanded:true, children:[{
					...
					text:'Kế toán ngân hàng'
					,data:'acc_bank'
					,children:[{
						text:'Giấy báo nợ - tiền gửi'
						,data:'acc_bank_out'
						,leaf:true
					},{
						text:'Giấy báo có - tiền gửi'
						,data:'acc_bank_in'
						,leaf:true
					},{
						text:'Giấy báo vay - tiền vay'
						,data:'acc_bank_in'
						,leaf:true
					},{
						text:'Giấy báo trả - tiền vay'
						,data:'acc_bank_in'
						,leaf:true
					}]
				},{
					text:'Kế toán bán hàng & dịch vụ'
						,data:'acc_bank'
						,children:[{
							text:'Bán hàng hóa'
							,data:'acc_bank_out'
