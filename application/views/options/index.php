<script type="text/javascript">
	...
	Ext.onReady(function() {
		...
		// create the Grid
		var acc_list_panel = Ext.create('Ext.grid.Panel', {
				store: store,
				//stateful: true,
				stateId: 'stateGrid',
				columns: [
		...
		*/
		...
		var grid_attributes = Ext.create('Ext.grid.Panel', {
				store: store,
				//stateful: true,
				stateId: 'stateGrid',
				columns: [
				...
				layout:'fit',
				autoScroll:true,
				title: "<? echo lang('tab_attributes'); ?>",
				//renderTo: 'grid-example',
				viewConfig: {
						stripeRows: true
				}
		...
		*/
		...
		/*
		// create the Grid of Clients & Suppliers
		var grid_clients_suppliers = Ext.create('Ext.grid.Panel', {
				store: store,
				//stateful: true,
				stateId: 'stateGrid',
				columns: [
				...
				layout:'fit',
				autoScroll:true,
				title: "<? echo lang('tab_clients_suppliers'); ?>",
				//renderTo: 'grid-example',
				viewConfig: {
						stripeRows: true
				}
		...
		*/
		...
		var grid_attributes = Ext.create('Ext.grid.property.Grid', {
				//width: 300,
	    ...
	    Ext.define('Task', {
		    ...
		    var store_tree = Ext.create('Ext.data.TreeStore', {
		        ...
		        proxy: {
		            ...
		            url: "<? echo site_url('options/json_data/treegrid'); ?>"
		        },
		        folderSort: true
		    });

		    //Ext.ux.tree.TreeGrid is no longer a Ux. You can simply use a tree.TreePanel
		    var tree_account = Ext.create('Ext.tree.Panel', {
		        title: "<? echo lang('tab_acc_chart'); ?>",
		        //width: 500,
		        //height: 300,
		        //renderTo: Ext.getBody(),
